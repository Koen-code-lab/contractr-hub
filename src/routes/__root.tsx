...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CONTRACTR — Bouw netwerk België" },
      { property: "og:description", content: "Match opdrachten en capaciteit. Het premium netwerk voor de Belgische bouw." },
